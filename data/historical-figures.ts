...
export const historicalFigures: HistoricalFigure[] = [
  {
    ...
    period: "1534年 - 1582年",
    catchphrase: "天下布武",
    quote: "鳴かぬなら 殺してしまえ ホトトギス。ワシと天下統一してみぬか？",
    image: "/images/nobunaga.jpg",
  ...
  },
  {
    ...
    name: "徳川家康",
    period: "1543年 - 1616年",
    catchphrase: "天下統一を成し遂げた男",
    quote: "鳴かぬなら 鳴くまで待とう ホトトギス。",
